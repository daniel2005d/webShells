    ...
    void BindDirectories(string basedirectory)
    {
        try
        {
            ...
            if (parentinfo != null)
            {
                ...
                li = string.Format("<li class='list-group-item list-group-item-action'><a href='{1}?file={0}'> ..</a></li>", b64, Request.Url.AbsolutePath.ToString());
            }
            ...
            foreach (string d in directories)
            {
                ...
                li += string.Format("<li class='list-group-item list-group-item-action'><a href='{2}?file={0}'> {1}</a></li>", b64, dinfo.Name, Request.Url.AbsolutePath.ToString());
